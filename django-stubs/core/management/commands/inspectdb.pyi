...
from typing import Any, Container, Dict, Iterator, List, Mapping, Tuple
...
class Command(BaseCommand):
    ...
    def normalize_col_name(self, col_name: str, used_column_names: Container[str], is_relation: bool) -> Tuple[str, Mapping[str, Any], List[str]]: ...
    def get_field_type(self, connection: Any, table_name: str, row: List[FieldInfo]) -> Tuple[str, Dict[str, Any], List[str]]: ...
    def get_meta(self, table_name: str, constraints: Any, column_to_field_name: Any, is_view: bool, is_partition: bool) -> List[str]: ...
