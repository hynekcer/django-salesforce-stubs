...
from typing import Any, Callable, Dict, Iterator, List, Optional, Protocol, Set, Sequence, Tuple, Type, Union
...
class NodeProto(Protocol):
    def as_sql(self, compiler: 'SQLCompiler', connection: 'django.db.backend.base.BaseDatabaseWrapper') -> Tuple[str, Sequence]: ...
...
class SQLCompiler:
    ...
    def as_sql(self, with_limits: bool = ..., with_col_aliases: bool = ...) -> Tuple[str, Sequence]: ...
...
class SQLInsertCompiler(SQLCompiler):
    ...
    def as_sql(self) -> Tuple[str, Sequence]: ...
