...
class ProtoCursor(Protocol):
    """Protocol of Cursor that is implemented in the low lever database driver"""
    def execute(self, query: str, params: Optional[Iterable] = None) -> Any: ...
    def executemany(self, query: str, param_list: Optional[Iterable[Iterable]]) -> Any: ...
...
class BaseDatabaseWrapper:
    ...
    def create_cursor(self, name: Optional[Any] = ...) -> ProtoCursor: ...
